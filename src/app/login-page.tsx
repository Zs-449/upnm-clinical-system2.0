...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden lg:flex-row">
      ...
      <div
        className="relative flex min-h-screen flex-1 flex-col justify-between overflow-hidden bg-[#0f1f1a] bg-cover bg-center p-8 text-white lg:p-12 lg:min-h-0"
        style={{ backgroundImage: "url('/images/login-hero-bg.jpg')" }}
      >
        {/* Dark overlay so text stays legible over the photo */}
        <div className="pointer-events-none absolute inset-0 bg-[#0f1f1a]/80" />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#0f1f1a] via-[#0f1f1a]/60 to-[#0f1f1a]/40" />
        ...
        <div className="relative z-10 flex items-center gap-3">
          <img src="/images/upnm-logo.png" alt="UPNM" className="h-16 w-16 rounded-2xl bg-white object-contain p-1 shadow-2xl ring-1 ring-white/20" />
          <div>
