...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden lg:flex-row">
      ...
      <div className="relative flex min-h-screen flex-1 flex-col justify-between overflow-hidden p-8 text-white lg:p-12 lg:min-h-0" style={{ backgroundImage: "url('/images/upnm-background.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
        {/* Dark overlay on background image */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[#0f1f1a]/30 via-[#0f1f1a]/40 to-[#0f1f1a]/60" />
