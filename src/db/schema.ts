...
// A full EMR consultation/visit record (chief complaint, vitals, diagnosis,
// treatment plan). Optionally linked to a prescriptions row created in the
// same "Save Record" action, so a visit's medication can be traced from
// either side without duplicating the prescription data itself.
